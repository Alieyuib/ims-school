        ...
        <div class="card shadow p-2">
            ...
            <div class="bg-orange text-center" id="show_all_students">
                ...
                <form action="{{ route('dashboard.invoice.generate.family') }}" method="POST">
                    ...
                    <input type="hidden" name="student_ffname" id="student_ffname" value="{{ $student_data->ffname }}">
                ...
                <form action="{{ route('dashboard.send.receipt.family') }}" method="POST">
                    @csrf
                    <input type="hidden" name="order_id_invoice" id="order_id_invoice" value="{{ $order_id }}">
                    <input type="hidden" name="student_email" id="student_email" value="{{ $student_data->email }}">
                    <input type="hidden" name="student_name" id="student_name" value="{{ $student_data->name }}">
        ...
        <div id="invoice">
          ...
          <div class="bg-orange" id="show_all_students">
            <div class="row">
              ...
              <h6 class="text-dark"><b class="text-dark">Family Name</b>: {{ $student_data->ffname }}</h6>
              ...
              <table class="table table-bordered table-striped align-middle table-hover mx-2">
                <thead>
                    <th>Students Name</th>
                </thead>
                <tbody>
  ...
  <script type="text/javascript" src="https://cdnjs.cloudflare.com/ajax/libs/html2canvas/0.4.1/html2canvas.js"></script>
    <script>
        ...
        $('#send_btn').on('click', function(e){
            ...
            let student_ffname = $('#student_ffname').val();
