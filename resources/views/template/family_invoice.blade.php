...
<body>
    <div class="row user-profile mt-1 ml-0 mr-0">
        <img class="responsive-img" alt="" src="data:image/png;base64,{{ base64_encode(file_get_contents(public_path('images/invoice_header_school.jpg'))) }}">
    </div>
    <div style="padding: 30px;">
        <div>
            ...
            <p style="margin-bottom: 20px;">
                <span style="float: right; width:50% margin-right:-100px; margin-top: -100px;">
