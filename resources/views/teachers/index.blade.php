...
@section('content')
    <div class="container-fluid">
        <div class="row d-flex justify-content-center align-items-center min-vh-100">
            <div class="col-md-3 card shadow p-20 text-center rounded-0 login-form-teacher">
                <img src="{{ asset('images/logo.jpg') }}" alt="" class="login-logo">
                <h3 class="text-ims-default">The Priority School</h3>
                <h5 class="text-ims-default">Teacher's Portal</h5>
                <div class="card-body">
                    <form action="" method="POST" id="login_form">
                        ...
                        <div class="mb-3 d-grid">
                            <input type="submit" value="Login" class="btn ims-bg-orange rounded-0" id="login_btn">
                        </div>
   ...
   <script>
       $(function(){
           $('#login_form').submit(function(e){
               ...
               $.ajax({
                   url: '{{ route('portal.teacher.login') }}',
                   method: 'post',
                   data: fd,
                   dataType:'json',
                   cache: false,
                   ...
                   success: function(res){
                       if (res.status == 400) {
                           ...
                           if (res.status == 200 && res.msg == 'success') {
                               ...
                               setTimeout(() => {
                                   window.location = '{{ route('portal.teacher.dashboard') }}'
                               }, 1000);
                           }
                       }
                   }
